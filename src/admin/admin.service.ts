...
export class AdminService {
    ...
    async rejectCompany(id: string) {
        ...
        await this.notificationsService.createForEmail(user.email, {
            ...
            message: 'Your HireAI company account request has been reviewed and rejected at this time.',
        });
    ...
    async getActivities() {
        ...
        return {
            ...
            recentUsers,
            stats: {
                totalCompanies: await this.prisma.user.count({ where: { role: Role.COMPANY } }),
                totalCandidates: await this.prisma.user.count({ where: { role: Role.CANDIDATE } }),
