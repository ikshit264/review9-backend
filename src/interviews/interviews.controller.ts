...
export class InterviewsController {
  ...
  async getTestSession(
    ...
    const { session, user, candidate } =
      await this.interviewsService.getOrCreateTestEnvironment(plan);
  ...
  async resumeInterview(
    ...
    return this.interviewsService.resumeInterview(
      sessionId,
      targetId,
      user.role,
    );
  ...
  async respondToInterview(
    ...
    return this.interviewsService.respondToInterview(
      sessionId,
      dto.answer,
      res,
    );
